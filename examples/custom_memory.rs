//! Example: Implementing a custom Memory backend for ViziClaw
//!
...
// ── Re-define the trait types (in your app, import from viziclaw::memory) ──
...
async fn main() -> anyhow::Result<()> {
    ...
    println!("🧠 ViziClaw Memory Demo — InMemoryBackend\n");
